...
/*
 *  burada SubscribeTableDependency()'i çaðýrmalýyýz
 * ara katman yazýlýmýnda oluþturuyoruz ve ara katman yazýlýmýnda SubscribeTableDependency() yöntemini çaðýrýyoruz
 */
